...
To build the code: you will simply download this GitHub repo and run it using Vivado. Or if you already have an opened Vivado project, all you need then is to copy the constraints, simulation, and source files into your project and run the simulation and the implementation.
